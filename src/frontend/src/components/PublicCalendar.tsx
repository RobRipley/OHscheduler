...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  headerRow: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px', position: 'relative' as const },
  ...
  dayCell: { minHeight: '140px', padding: '8px', borderRight: `1px solid ${theme.border}`, background: theme.surface, overflow: 'hidden', minWidth: 0 },
